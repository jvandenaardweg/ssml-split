...
class PollySSMLSplit {
    ...
    configure(options) {
        ...
        this[_includeSSMLTags] = options.includeTags || false // true if you want the complete SSML tag characters to be included in the split count (required for Google TTS)
    ...
    split(ssml) {
        ...
        this[_textLength] = 0
        this[_characterCounter] = this[_includeSSMLTags] ? this[_accumulatedSSML] : this[_textLength];
