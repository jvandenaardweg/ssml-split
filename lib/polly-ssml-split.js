...
class PollySSMLSplit {
    ...
    configure(options) {
        ...
        this[_includeSSMLTags] = options.includeSSMLTags || false 
    ...
    split(ssml) {
        ...
        this[_root].children.forEach(node => {
            this[_characterCounter] = this[_includeSSMLTags] ? this[_accumulatedSSML].length : this[_textLength];
